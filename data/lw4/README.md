Необходимо решить набор задач из общего списка данной лабораторной работы: 3 штуки. Перечень задач индивидуален для каждого студента.
...
Формулировки заданий смотри [здесь](./projects/_content/).