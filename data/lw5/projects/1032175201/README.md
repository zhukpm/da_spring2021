...
* задание 1. Параметры 'race/ethnicity' и 'writing score';
* задание 2. Параметры 'test preparation course' и 'math score';
* задание 3. Параметры 'parental level of education' и 'math score'.
