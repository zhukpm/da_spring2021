...
* задание 1. Параметры 'parental level of education' и 'math score';
* задание 2. Параметры 'race/ethnicity' и 'reading score';
* задание 3. Параметры 'writing score' и 'reading score'.
