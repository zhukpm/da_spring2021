...
* задание 1. Параметры 'parental level of education' и 'writing score';
* задание 2. Параметры 'gender' и 'reading score';
* задание 3. Параметры 'test preparation course' и 'writing score'.
