...
* задание 1. Параметры 'test preparation course' и 'reading score';
* задание 2. Параметры 'math score' и 'reading score';
* задание 3. Параметры 'parental level of education' и 'writing score'.
